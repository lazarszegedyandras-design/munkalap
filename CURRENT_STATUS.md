...
- A felmérés kezdetén a `C:\Munkalap` nem volt Git-repository. Az első commit (`b8fbedd`) a GitHub `main` ágán van; a tárhely nyilvános. A `main` ágon GitHub ágvédelem kér pull requestet és a két CI-job sikerét, tiltja a kényszerített feltöltést és a törlést, és az adminisztrátorra is vonatkozik.
